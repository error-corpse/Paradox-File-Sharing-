...
# Your db channel Id
# -1002219047037
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002213146798"))
...
# Fsub 1
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002151903452"))
...
# Default admin IDs
admins_list = "6259443940, 6331067820, 5053815620, 5769925013, 6808832512, 1270076250, 6693143450, 5404195701"
